...
file_handler = logging.FileHandler('productionplan.log')
...
formatter = logging.Formatter("%(asctime)s — %(name)s — %(levelname)s —""%(funcName)s:%(lineno)d — %(message)s")
file_handler = logging.FileHandler('productionplanRuntimeError.log')
file_handler.setFormatter(formatter)
...
class ProductionPlan(Resource):
    ...
    def post(self):
        ...
        if json_data == None:
            ...
            abort("The data provided is not a json file. Please provide one.")
        ...
        try:
            ...
            abort("RuntimeError during the initialisation of the unit commitment algorithm class. Check log file for more information.")
        ...
        try:
            ...
            abort("RuntimeError during the payload format checking. Check log file for more information.")
        ...
        try:
            ...
            abort("RuntimeError while updating the pmax, price according to the efficiency data and wind%. Check log file for more information.")
        ...
        try:
            ...
            abort("RuntimeError while looking for all the combinasions of powerplants that can provide the needed load or more. Check log file for more information.")
        ...
        try:
            ...
            abort("RuntimeError while looking for  all the powerplants that can have their power output reduce to have the combinasion be equal to the targeted load or more close if none can and sorting the output by power provided. Check log file for more information.")
        ...
        try:
            ...
            abort("RuntimeError while selecting the combinasion of powerplant that is equal to the targeted load and the cheapest our the one closest to the targeted load.. Check log file for more information.")
